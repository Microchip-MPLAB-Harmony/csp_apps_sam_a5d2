...
| sam_a5d2_xult_iar.IAR/shdwc_piobu0_wakeup_sam_a5d2_xult_iar.eww | IAR project for [SAMA5D2 Xplained Ultra Evaluation Kit](https://www.microchip.com/DevelopmentTools/ProductDetails/ATSAMA5D2C-XULT) |
|||
...
| Project Name| Board|
|:---------|:---------:|
| sam_a5d2_xult.X <br> sam_a5d2_xult_iar.IAR/shdwc_piobu0_wakeup_sam_a5d2_xult_iar.eww | [SAMA5D2 Xplained Ultra Evaluation Kit](https://www.microchip.com/DevelopmentTools/ProductDetails/ATSAMA5D2C-XULT) |
|||
...
7. Short the PIOBU wakeup pin to 3.3V supply to wakeup the device
8. Device resets (indicated by the LED starting to toggle again)

Following table provides details of switch and LED:

| Board      | Switch Name |  LED Name | PIOBU pin |
| ---------- | ----------- | --------- | --------- |
| [SAMA5D2 Xplained Ultra Evaluation Kit](https://www.microchip.com/DevelopmentTools/ProductDetails/ATSAMA5D2C-XULT) | PB_USER | RGB_LED(Blue) | PIN 1 of Connector J12 |
||||
