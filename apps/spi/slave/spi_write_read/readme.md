...
1. Build and Program the SPI master application project using its IDE on board. Path of the SPI Master application within the repository is **apps/spi/master/spi_write_read_test_app/firmware**
