...
| ---------- | ---------------- |--------- |
|  [SAMA5D29 Curiosity Development Board](https://www.microchip.com/en-us/development-tool/EV07R15A)  | PD6 (Pin #11 on on the 40-pin GPIO Connector (J25)) | RGB_LED(Blue) |
||||